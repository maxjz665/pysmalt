...
class TblText(models.Model):
    ...
    author = models.ForeignKey(TblAuthor, related_name='author_data', on_delete=models.SET_NULL, null=True, blank=True, db_column='AUTHOR_ID')
    magazine = models.ForeignKey(TblMagazine, on_delete=models.SET_NULL, null=True, blank=True, db_column='MAGAZINE_ID')
    magazine_no = models.CharField(max_length=255, null=True, blank=True, db_column='MAGAZINE_NO')
    publication_date = models.DateField(null=True, blank=True, db_column='PUBLICATION_DATE')
    comment = models.TextField(max_length=1000, null=True, blank=True, db_column='COMMENT')
    url = models.URLField(max_length=1000, null=True, blank=True, db_column='URL')
    background = models.ImageField(max_length=1000, null=True, blank=True, db_column='BACKGROUND')
    inuse1 = models.IntegerField(default=1, db_column='INUSE1')
    inuse2 = models.IntegerField(default=0, db_column='INUSE2')  # Возможно в будущем удалить тексты новой разметки т.к. не используются
    syntax = models.IntegerField(default=0, db_column='SYNTAX')
    category = models.IntegerField(default=0, db_column='CATEGORY')
    text_type = models.IntegerField(default=0, db_column='TEXT_TYPE')
    author_verify = models.IntegerField(default=0, db_column='AUTHOR_VERIFY')
    author_type = models.IntegerField(default=0, blank=True, null=True, db_column='AUTHOR_TYPE')
    author2 = models.ForeignKey(TblAuthor, related_name='author2_data', on_delete=models.SET_NULL, null=True,
                                blank=True, db_column='AUTHOR2_ID')
    author2_type = models.IntegerField(default=0, blank=True, null=True, db_column='AUTHOR2_TYPE')
    author3 = models.ForeignKey(TblAuthor, related_name='author3_data', on_delete=models.SET_NULL, null=True,
                                blank=True, db_column='AUTHOR3_ID')
    author3_type = models.IntegerField(default=0, blank=True, null=True, db_column='AUTHOR3_TYPE')
    short_title = models.TextField(null=True, blank=True, db_column='SHORT_TITLE')
    magazine_volume = models.CharField(max_length=255, null=True, blank=True, db_column='MAGAZINE_VOLUME')
    magazine_section = models.CharField(max_length=255, null=True, blank=True, db_column='MAGAZINE_SECTION')
    pages = models.CharField(max_length=255, null=True, blank=True, db_column='PAGES')
    censorship = models.TextField(null=True, blank=True, db_column='CENSORSHIP')
    attributions = models.TextField(null=True, blank=True, db_column='ATTRIBUTIONS')
    status = models.IntegerField(default=0, db_column='STATUS')
    idkey = models.CharField(max_length=255, null=True, blank=True, db_column='IDKEY')
    origin_title = models.TextField(null=True, blank=True, db_column='ORIGIN_TITLE')
